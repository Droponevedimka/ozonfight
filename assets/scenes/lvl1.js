...
class lvl1 extends Phaser.Scene {
	...
	create(){
		...
		this.add.image(1706.5012, 164.824, "antoganist", "skuka.png");
		
		this.add.text(1150.6542, 63.64301, "Скука Смертная\r\n", {
    "fontFamily": "Aldrich",
    "fontSize": "56px"
});
	...
	animationGamer(data){	
		var buf = data.slice (0, -1);
			...
			this.anims.create({
				...
				frames: [{
					key: "skuka",
					frame: "skuka_attack_new00.png"
					}, {
					key: "skuka",
					frame: "skuka_attack_new01.png"
				}, {
					key: "skuka",
					frame: "skuka_attack_new02.png"
				}, {
					key: "skuka",
					frame: "skuka_attack_new03.png"
				}, {
					key: "skuka",
					frame: "skuka_attack_new04.png"
				}, {
					key: "skuka",
					frame: "skuka_attack_new05.png"
				}, {
					key: "skuka",
					frame: "skuka_attack_new06.png"
				}, {
					key: "skuka",
					frame: "skuka_attack_new07.png"
				}, {
					key: "skuka",
					frame: "skuka_attack_new08.png"
				}
				],
				frameRate: 9,
				repeat: 0
			...
			this.anims.create({
				...
				frames: [{
					key: "skuka",
					frame: "skuka_glory00.png"
					}, {
					key: "skuka",
					frame: "skuka_glory01.png"
				}, {
					key: "skuka",
					frame: "skuka_glory02.png"
				}, {
					key: "skuka",
					frame: "skuka_glory03.png"
				}, {
					key: "skuka",
					frame: "skuka_glory04.png"
				}, {
					key: "skuka",
					frame: "skuka_glory05.png"
				}, {
					key: "skuka",
					frame: "skuka_glory06.png"
				}, {
					key: "skuka",
					frame: "skuka_glory07.png"
				}, {
					key: "skuka",
					frame: "skuka_glory08.png"
				}, {
					key: "skuka",
					frame: "skuka_glory09.png"
				}
				],
				frameRate: 10,
				repeat: 1
			...
			this.anims.create({
				...
				frames: [{
					key: "skuka",
					frame: "skuka_hit_new00.png"
					}, {
					key: "skuka",
					frame: "skuka_hit_new01.png"
				}, {
					key: "skuka",
					frame: "skuka_hit_new02.png"
				}, {
					key: "skuka",
					frame: "skuka_hit_new03.png"
				}
				],
				frameRate: 4,
				repeat: 0
			...
			this.anims.create({
				...
				frames: [{
					key: "skuka",
					frame: "skuka_k.o._new00.png"
				}, {
					key: "skuka",
					frame: "skuka_k.o._new01.png"
				}, {
					key: "skuka",
					frame: "skuka_k.o._new02.png"
				}, {
					key: "skuka",
					frame: "skuka_k.o._new03.png"
				}, {
					key: "skuka",
					frame: "skuka_k.o._new04.png"
				}
				],
				frameRate: 5,
				repeat: 0
	...
	animationAntoganist(buf){
		this.anims.create({
			...
			frames: [{
				key: "attackAction",
				frame: buf+"_fireball_lvl100.png"
				}, {
					key: "attackAction",
					frame: buf+"_fireball_lvl101.png"
				}, {
					key: "attackAction",
					frame: buf+"_fireball_lvl102.png"
				}, {
					key: "attackAction",
					frame: buf+"_fireball_lvl103.png"
				}, {
					key: "attackAction",
					frame: buf+"_fireball_lvl104.png"
				}, {
					key: "attackAction",
					frame: buf+"_fireball_lvl105.png"
				}, {
					key: "attackAction",
					frame: buf+"_fireball_lvl106.png"
				}, {
					key: "attackAction",
					frame: buf+"_fireball_lvl107.png"
				}, {
					key: "attackAction",
					frame: buf+"_fireball_lvl108.png"
				}, {
					key: "attackAction",
					frame: "_"
				}
		...
		this.anims.create({
			...
			frames: [{
				key: "attackAction",
				frame: "skuka_poison_new00.png"
				}, {
				key: "attackAction",
				frame: "skuka_poison_new01.png"
			}, {
				key: "attackAction",
				frame: "skuka_poison_new02.png"
			}, {
				key: "attackAction",
				frame: "skuka_poison_new03.png"
			}, {
				key: "attackAction",
				frame: "skuka_poison_new04.png"
			}, {
				key: "attackAction",
				frame: "skuka_poison_new05.png"
			}, {
				key: "attackAction",
				frame: "skuka_poison_new06.png"
			}, {
				key: "attackAction",
				frame: "skuka_poison_new07.png"
			}, {
				key: "attackAction",
				frame: "_"
			}
	...
	winGame(){		
		...
		this.time.delayedCall(3000, function(){
			this.scene.start("lvl1buf", { why: this.person, whyName: this.personName, healLvl:this.healGamerItem });	
			document.getElementById("pause-game-back-black").style.opacity = 1;
		},[], this);		
	}
	...
	attackGamer(){
		...
		if (this.healAntagonistItem > 0){			
			this.healAntagonistItem -= 50;
			
			this.gamer.play("attack");	

			this.time.delayedCall(200, function(){										
				this.attackAnimGamer.play("fireball_lvl1");		
			},[], this);

			this.time.delayedCall(800, function(){		
				this.sound.play('hit-swoosh');								
				this.skuka.play("skuka_hit");	
				this.getHealAntagonist(this.healAntagonistItem);
			},[], this);
			...
			this.time.delayedCall(1600, function(){										
				if(this.healAntagonistItem!=0) {
					...
					this.skuka.play("skuka_ko");
				}	
			},[], this);

			
			if(this.healAntagonistItem != 0) {
				if(this.healAntagonistItem  >= 50){
					this.showText("Это за последний сезон\n «Игры Престолов»!", "pers");
				} else {
					this.showText("Я — реальный герой, \nа не диванный!", "pers");
				}
			} else {					
	...
	attackAntoganist(){	
		...
		if (this.healGamerItem > 0){
			...
			this.skuka.play("skuka_attack");

			this.time.delayedCall(200, function(){										
				this.attackAnimGamer.play("skuka_poison");	
			},[], this);
			...
			if(this.healGamerItem > 0){
				if(this.healGamerItem > 40){
					this.showText("Живи на 10 баллов\n — всегда в пробках", "ant");	
				} else {
					this.showText("6 часов в Инсте? Глянь \nеще пару сторис…", "ant");
				}
				
			} else {
				this.time.delayedCall(1300, function(){										
					this.skuka.play("skuka_glory");
				},[], this);
